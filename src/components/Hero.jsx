...
const Hero = () => {
    ...
    return (
        <section className="relative min-h-screen md:min-h-screen flex items-center justify-center pt-32 pb-40 md:py-20 px-6">
            {/* Background Elements */}
            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-12 items-center relative z-10">
                <motion.div
                    ...
                    className="text-center md:text-left order-2 md:order-1 pt-4 md:pt-0"
                >
                ...
                <motion.div
                    ...
                    className="relative order-1 md:order-2 mb-20 md:mb-0"
                >
                    <div className="relative w-full aspect-square max-w-[260px] sm:max-w-[400px] md:max-w-[500px] mx-auto">
                        <div className="absolute inset-[-5%] organic-shape bg-gradient-to-br from-nature-400 via-sky-400 to-gold-400 shadow-2xl opacity-70 animate-growth" />
                        <div className="absolute inset-0 organic-shape bg-white/95 backdrop-blur-md flex items-center justify-center p-6 md:p-10 text-center border border-white shadow-xl">
                            <div className="relative z-10 w-full flex flex-col items-center">
                                <div className="w-24 h-24 md:w-32 md:h-32 bg-nature-100 rounded-full flex items-center justify-center mb-4 md:mb-6 shadow-md overflow-hidden border-4 border-white shrink-0">
                                    <img src={karlaPic} alt="Karla Rodríguez Santos" className="w-full h-full object-cover" />
                                </div>
                                <h3 className="text-xl md:text-2xl font-bold text-slate-800 mb-1 leading-tight whitespace-nowrap">Karla Rodríguez Santos</h3>
